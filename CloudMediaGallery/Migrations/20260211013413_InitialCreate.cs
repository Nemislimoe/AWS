    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                    SearchQuery = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CollectionSubscriptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CollectionSubscriptions_AspNetUsers_SubscriberId",
                        column: x => x.SubscriberId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CollectionSubscriptions_Collections_CollectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CollectionMedias", x => new { x.CollectionId, x.MediaFileId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CollectionMedias_MediaFiles_MediaFileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_MediaFiles_MediaFileId",
                        column: x => x.MediaFileId,
                        principalTable: "MediaFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Likes_MediaFiles_MediaFileId",
                        column: x => x.MediaFileId,
                        principalTable: "MediaFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ratings_MediaFiles_MediaFileId",
                        column: x => x.MediaFileId,
                        principalTable: "MediaFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFavoriteTags", x => new { x.UserPreferenceId, x.TagId });
                    table.ForeignKey(
                        name: "FK_UserFavoriteTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFavoriteTags_UserPreferences_UserPreferenceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CollectionMedias_MediaFileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CollectionSubscriptions_CollectionId",
                table: "CollectionSubscriptions",
                column: "CollectionId");

            migrationBuilder.CreateIndex(
                name: "IX_CollectionSubscriptions_SubscriberId_CollectionId",
                table: "CollectionSubscriptions",
                columns: new[] { "SubscriberId", "CollectionId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Likes_MediaFileId",
                table: "Likes",
                column: "MediaFileId");

            migrationBuilder.CreateIndex(
                name: "IX_Likes_UserId_MediaFileId",
                table: "Likes",
                columns: new[] { "UserId", "MediaFileId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MediaFiles_IsBlocked",
                table: "MediaFiles",
                column: "IsBlocked");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ratings_MediaFileId",
                table: "Ratings",
                column: "MediaFileId");

            migrationBuilder.CreateIndex(
                name: "IX_Ratings_UserId_MediaFileId",
                table: "Ratings",
                columns: new[] { "UserId", "MediaFileId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFavoriteTags_TagId",
